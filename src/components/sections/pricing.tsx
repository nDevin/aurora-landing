...
const plans = [
  {
    ...
    period: "月",
    features: [
      { name: "智能补全", included: true },
      { name: "对话次数", value: "100次/月" },
      { name: "客服支持", value: "5×8小时" },
      { name: "基础模型", included: true },
  ...
  },
  {
    ...
    features: [
      { name: "智能补全", included: true },
      { name: "对话次数", value: "无限" },
      { name: "客服支持", value: "7×8小时" },
      { name: "高级模型", included: true },
  ...
  },
  {
    ...
    features: [
      { name: "智能补全", included: true },
      { name: "对话次数", value: "无限" },
      { name: "客服支持", value: "24/7全天候" },
      { name: "企业级模型", included: true },
      { name: "API访问", included: true },
